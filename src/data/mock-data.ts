...
export const mockHCPData: HCP[] = [
	{
		...
		publications: [
			...
			{
				title: "Cardiac Imaging in Modern Practice",
				journal: "Circulation",
				year: "2022",
				citations: 78,
			},
			{
				title: "Interventional Techniques in Complex Cases",
		...
		connections: [
			{
				hcpId: "2",
				type: "Co-authorship",
				description: "Co-authored 5 papers on cardiac imaging",
				strength: "Strong",
			},
			{
				hcpId: "3",
				type: "Workplace",
				description: "Worked together at City Medical Center",
				strength: "Medium",
			},
			{
				hcpId: "4",
				type: "Education",
				description: "Both completed fellowship at Mayo Clinic",
				strength: "Medium",
			},
			{
				hcpId: "5",
				type: "Research",
				description: "Collaborated on heart failure research",
				strength: "Strong",
			},
		],
	},
	{
		...
		education: [
			...
			{
				degree: "Fellowship in Cardiac Imaging",
		...
		workExperience: [
			{
				position: "Director of Cardiac Imaging",
				organization: "Metropolitan Hospital",
				duration: "2016 - Present",
			},
			{
				position: "Imaging Specialist",
				organization: "Regional Heart Center",
				duration: "2011 - 2016",
			},
		],
		publications: [
			{
				title: "Advanced MRI Techniques in Cardiology",
				journal: "Radiology",
				year: "2023",
				citations: 67,
			},
		...
		connections: [
			...
			},
			{
				hcpId: "6",
				type: "Workplace",
				description: "Current colleagues at Metropolitan Hospital",
				strength: "Strong",
			},
		],
	},
	{
		...
		workExperience: [
			{
				position: "Senior Electrophysiologist",
				organization: "Heart Rhythm Center",
		...
		publications: [
			{
				title: "Modern Ablation Techniques",
				journal: "Heart Rhythm",
				year: "2023",
				citations: 34,
			},
			{
				title: "Device Management in Complex Cases",
				journal: "Pacing",
				year: "2022",
				citations: 56,
			},
		...
		connections: [
			...
			},
			{
				hcpId: "4",
				type: "Research",
				description: "Joint research on arrhythmia management",
				strength: "Medium",
			},
		],
	},
	{
		...
		publications: [
			{
				title: "Complex PCI Strategies",
				journal: "Catheterization",
				year: "2023",
				citations: 89,
			},
			{
	...
	},
	{
		...
		education: [
			...
			{
				degree: "Fellowship in Heart Failure",
		...
		workExperience: [
			...
			{
				position: "Heart Failure Cardiologist",
				organization: "Transplant Institute",
				duration: "2014 - 2019",
			},
		],
		publications: [
			...
			{
				title: "Mechanical Support Devices",
		...
		connections: [
			...
			},
			{
				hcpId: "6",
				type: "Education",
				description: "Both trained at Columbia University",
				strength: "Weak",
			},
		],
	},
	{
		...
		education: [
			...
			{
				degree: "Fellowship in Preventive Cardiology",
				institution: "Columbia University",
				year: "2015",
			},
		],
		workExperience: [
			...
			{
				position: "Preventive Cardiologist",
				organization: "Wellness Heart Center",
				duration: "2015 - 2020",
			},
		],
		publications: [
			{
				title: "Lipid Management Guidelines",
				journal: "Prevention",
				year: "2023",
				citations: 78,
			},
			{
				title: "Hypertension in Modern Practice",
	...
	connectedHcpIds.forEach((hcpId) => {
		...
		if (hcp) {
			hcp.connections.forEach((connection) => {
				const secondDegreeHcp = mockHCPData.find(
					(h) => h.id === connection.hcpId,
				);
				if (
					secondDegreeHcp &&
