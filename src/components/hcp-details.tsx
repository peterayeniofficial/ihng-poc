  ...
  return (
    ...
    >
      <Card className="bg-gradient-to-br from-blue-50 to-purple-50 shadow-md">
        <CardContent className="p-6">
          <div className="text-center space-y-4">
            ...
            <div className="flex space-x-2" role="group" aria-label="Profile actions">
              <Button
      ...
      <section aria-labelledby="about-heading">
        <h3 id="about-heading" className="font-semibold text-gray-900 mb-2">About</h3>
      ...
      <section aria-labelledby="education-heading">
        <h3 id="education-heading" className="font-semibold text-gray-900 mb-3">Education</h3>
        <div className="flex items-start space-x-3">
          <div className="w-8 h-8 bg-blue-600 rounded flex-shrink-0" aria-hidden="true" />
          <div>
            <h4 className="font-medium text-gray-900">Harvard Medical University</h4>
            <p className="text-sm text-gray-600">Cardiology Degree</p>
            <p className="text-sm text-gray-600">Specialization in Heart Health</p>
